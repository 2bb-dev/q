...
//!
//! Ported from `a3io/q:src-tauri/src/lib.rs::save_image / delete_image /
//! copy_image_to_clipboard / delete_all_images`. The Tauri clipboard-image
//! API is replaced by `arboard::ImageData`.
//!
