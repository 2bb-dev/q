...
//!
//! Ported from `a3io/q:src-tauri/src/lib.rs`. Tauri-specific wrappers
...
///
/// Ported verbatim from `a3io/q:src-tauri/src/lib.rs`.
...
///
/// Ported from `a3io/q:src-tauri/src/lib.rs::bearer_request`.
